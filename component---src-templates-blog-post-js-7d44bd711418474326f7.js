...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _deepEqual = __webpack_require__(63);
	
	var _deepEqual2 = _interopRequireDefault(_deepEqual);
	
	var _HelmetUtils = __webpack_require__(101);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Adsense = function (_React$Component) {
	  _inherits(Adsense, _React$Component);
	  ...
	  Adsense.prototype.componentDidMount = function componentDidMount() {
	  ...
	  Adsense.prototype.render = function render() {
	    var _props = this.props,
	        clientId = _props.clientId,
	        slotId = _props.slotId,
	        format = _props.format;
	
	    console.log(clientId);
	
	    return clientId ? _react2.default.createElement(
	      'div',
	      { className: 'ad' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _forEach = __webpack_require__(186);
	...
	var _size = __webpack_require__(188);
	
	var _size2 = _interopRequireDefault(_size);
	
	var _Adsense = __webpack_require__(128);
	
	var _Adsense2 = _interopRequireDefault(_Adsense);
	
	var _ReadNext = __webpack_require__(129);
	...
	var SitePost = function (_React$Component) {
	  ...
	  SitePost.prototype.componentDidMount = function componentDidMount() {
	    var _props = this.props,
	        data = _props.data,
	    ...
	    var disqus_config = function disqus_config() {
	      debugger;
	      this.page.url = 'https://blog.disasterdev.net/' + path;
	      this.page.identifier = path.replace(/\//g, '');
	    };
	    ...
	    (function () {
	      ...
	      s.src = 'https://diasterdev.disqus.com/embed.js';
	      s.setAttribute('data-timestamp', +new Date());
	      (d.head || d.body).appendChild(s);
	    })();
	  };
	
	  SitePost.prototype.more = function more(path) {
	    return _react2.default.createElement(
	  ...
	  SitePost.prototype.isMore = function isMore(body) {
	  ...
	  SitePost.prototype.categories = function categories(data) {
	    var categories = [];
	    (0, _forEach2.default)(data, function (item, i) {
	  ...
	  SitePost.prototype.render = function render() {
	    ...
	    var description = (0, _get2.default)(data, 'frontmatter.description') || this.description(html);
	    var cate = (0, _get2.default)(data, 'frontmatter.category') || (0, _get2.default)(data, 'frontmatter.categories');
	    var isMore = isIndex && !!html.match('<!--more-->');
	    var ad = isIndex ? '' : _react2.default.createElement(_Adsense2.default, { clientId: site.meta.adsense, slotId: '', format: 'auto' });
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          ad,
	          isIndex ? '' : _react2.default.createElement(_ReadNext2.default, { data: site }),
	          !isIndex && _react2.default.createElement('div', { id: 'disqus_thread' })
	        )
	      )
	    );
	  };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var asciiSize = __webpack_require__(170),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var baseKeys = __webpack_require__(69),
	    ...
	    stringSize = __webpack_require__(184);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactHelmet = __webpack_require__(100);
	...
	var _striptags = __webpack_require__(466);
	
	var _striptags2 = _interopRequireDefault(_striptags);
	
	var _SitePost = __webpack_require__(130);
	
	var _SitePost2 = _interopRequireDefault(_SitePost);
	
	var _SitePage = __webpack_require__(253);
	...
	var BlogPostTemplate = function (_React$Component) {
	  ...
	  BlogPostTemplate.prototype.componentDidUpdate = function componentDidUpdate() {
	    fixTableClass();
	  };
	  ...
	  BlogPostTemplate.prototype.render = function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactHelmet2.default, {
	        ...
	        meta: [{ property: 'og:title', content: (0, _get2.default)(post, 'frontmatter.title') }, { property: 'og:type', content: 'article' }, {
...
//# sourceMappingURL=component---src-templates-blog-post-js-7d44bd711418474326f7.js.map